...
namespace AsynchronousProgramming
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            // t1.Start();
            // Task t2 = Task.Run(new Action(ConcatenateChars))
            ...
            /*
            var t = Task.Factory.StartNew(() => ConcatenateChars(charToConcatenate, count));
            ...
            */
            ...
            var t2 = ConcatenateCharsAsync(charToConcatenate, count);
            //t2.Wait();
            Console.WriteLine("\nAfter starting async method.");
            Console.WriteLine($"\nMethod two example with Length = {t2.Result.Length}.");
